...
DESCRIPTIONS = {
    ...
    "hy_armtdp":
        "UD_Armenian-ArmTDP is based on the ՀայՇտեմ-ArmTDP-East dataset "
        "(version 2.0), a mix of random sentences sampled from different "
        "sources and representing different genres and domains, released in "
        "several formats (local on-line newspaper and journal articles, "
        "contemporary fiction dated between 1976 and 2019). The treebank "
        "consists 2502 sentences (~53K tokens).",
    "aii_as":
